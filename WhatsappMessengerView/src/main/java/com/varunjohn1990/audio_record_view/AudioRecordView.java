...
public class AudioRecordView {
    ...
    private ConstraintLayout llChangeStatus  , llSickInfo ,llSickDoc , llSickHistory;
    private Button btnEnd , btnClose,btnCloseSickInfo;
    ...
    private TextView timeText, textViewSlide, tvSickDesc, tvSickName , tvLockCancel;
    ...
    public void initView(ViewGroup view) {
        ...
        llChangeStatus = view.findViewById(R.id.llChangeStatus);
        btnClose = view.findViewById(R.id.btn_close);

        llSickInfo = view.findViewById(R.id.llSickInfo);
        llSickDoc = view.findViewById(R.id.llSickDoc);
        llSickHistory = view.findViewById(R.id.llSickHistory);
        btnCloseSickInfo = view.findViewById(R.id.btnCloseSickInfo);
        ...
        tvSickDesc = view.findViewById(R.id.tv_sick_desc);
        tvSickName = view.findViewById(R.id.tv_sick_name);
        tvLockCancel = view.findViewById(R.id.tvLockCancel);
    ...
    public View getllChangeStatus() {
        return llChangeStatus;
    }
    public View getBtnEnd() {
        return btnEnd;
    }
    ...
    public View getBtnCloseSickInfo() {
        return btnCloseSickInfo;
    }

    public View getLayoutMessage(){
        return layoutMessage;
    }
    public TextView getTvSickDesc (){
        return tvSickDesc;
    }
    public TextView getTvSickName (){
        return tvSickName;
    }

    public View getLlSickDoc() {
        return llSickDoc;
    }

    public View getLlSickHistory() {
        return llSickHistory;
    }

    public View getLlSickInfo() {
        return llSickInfo;
    }
    ...
    private void setupRecording() {
        ...
        tvLockCancel.setOnClickListener(new View.OnClickListener(){
            @Override
    ...
    private void stopRecording(RecordingBehaviour recordingBehaviour) {
        ...
        if (recordingBehaviour == RecordingBehaviour.LOCKED) {
            ...
            tvLockCancel.setVisibility(View.VISIBLE);
            ...
            tvLockCancel.setVisibility(View.GONE);
